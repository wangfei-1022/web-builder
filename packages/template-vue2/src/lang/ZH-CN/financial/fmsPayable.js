export default {
  ...
  unsupportCreateBill: '同一结算单位仅允许海外仓配业务+单据类型海外仓配业务③费用生成同一账单',
  ...
  applyPayment: '申请付款',
  paymentReport: '付款报告',
  paymentStateName: '付款状态',
  UN_APPLY_INVOICE: '已对账待收票',
  UN_VERIFY: '待对账',
  supplier_name: '供应商',
  product_names: '所属产品',
  payable_sum: '应付合计',
  payable_pay_date: '实际付款日期',
  applyPaymentInfo: '申请付款信息',
  instructionByNames: '申请核销/付款人',
  lastPayDateTime: '实际付款时间',
  instructionStateNamePayable: '申请核销/付款状态',
  arTotalList: '应收账款',
  arUnclearTotalList: '未收账款',
  profitList: '利润合计',
  profitCnyList: '利润人民币合计',
  apApplyAmounts: '申请付款原币',
  apApplyStandardAmount: '申请付款本位币',
  arClearedAmounts: '已收账款原币',
  arClearedStandardAmount: '已收账款本位币',
  eta: 'ETA',
  customerBL: '客户提单',
  businessTag: '业务标签'
}

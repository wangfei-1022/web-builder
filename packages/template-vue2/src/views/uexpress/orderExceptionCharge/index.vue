<template>
  <div class="right-main-wrapper" v-loading="loading">
      ...
      <template slot="multipleSearch">
        <div class="multiple-form-wrap">
          <el-form ref="formDataRef" :inline="true" :model="formData" label-width="100px" size="mini">
            ...
            <el-form-item label="">
              <template slot="label">
                <el-select v-model="formData.noType" style="width: 100px;">
                  ...
                  <el-option :label="$t('uexpressOrder.boxNo')" value="boxNo"></el-option>
                  <el-option :label="$t('uexpressOrder.outboundNo')" value="outboundNo"></el-option>
                </el-select>
              </template>
            ...
            <el-form-item :label='$t("uexpressOrder.abnormalityState")' prop="abnormalityState">
    ...
    <div >
      <el-tabs v-model="abnormalityType" class="middle-tabs" @tab-click="abnormalityTypeTabsClick">
        <el-tab-pane :label='$t("uexpressOrder.NOT_INBOUND_COST_INSPECTION") + "(" + NOT_INBOUND_COST_INSPECTION + ")"' name="560"></el-tab-pane>
        <el-tab-pane :label='$t("uexpressOrder.OUTBOUND_COST_INSPECTION") + "(" + OUTBOUND_COST_INSPECTION + ")"' name="570"></el-tab-pane>
        <el-tab-pane :label='$t("uexpressOrder.ALL") + "(" + ALL + ")"' name="580"></el-tab-pane>
      </el-tabs>
      <ag-grid-vue
...
import {
  ...
  getOrderExceptionChargeCountApi
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      abnormalityType: '560', // 未妥投异常
      abnormalityState: '',

      NOT_INBOUND_COST_INSPECTION: 0,
      OUTBOUND_COST_INSPECTION: 0,
      ALL: 0,
      ...
      columnFields: [{
        ...
        {
          field: "orderBusinessType",
          headerName: this.$t("uexpressOrder.orderBusinessType"),
          minWidth: 100
        },
        {
        ...
        {
          field: 'boxingTime',
          headerName: this.$t("uexpressOrder.boxingTime"),
          minWidth: 150
        },
        {
          field: 'outboundTime',
        ...
        {
          field: "totalAmount",
          headerName: this.$t("uexpressOrder.totalChargeAmount"),
          minWidth: 120,
          type: 'numericColumn',
          cellRenderer: params => formatNumberToThousands(params.data.totalAmount) + params.data.totalAmountCurrency
        },
        {
          field: "predictTime",
  ...
  methods: {
    getChargeCount() {
      getOrderExceptionChargeCountApi().then(res => {
        if (res.ok) {
          res.content.forEach(v => {
            if (v.code === 560) {
              this.NOT_INBOUND_COST_INSPECTION = v.count
            }
            if (v.code === 570) {
              this.OUTBOUND_COST_INSPECTION = v.count
            }
            if (v.code === 580) {
              this.ALL = v.count
            }

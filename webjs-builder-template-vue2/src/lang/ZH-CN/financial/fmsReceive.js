export default {
  ...
  add_charge_info_success: '新增费用成功',
  change_charge: '调整费用',
  ...
  clear_desc_1: '只有核销状态为未核销或者部分核销才能进行操作',
  clear_desc_2: '只有申请核销状态为未申请或者部分申请才能进行操作',
  clear_desc_3: "不是同一家结算单位的不支持一起操作！",
  clear_desc_4: '只有费用确认单确认状态为已确认才能进行操作',
  clear_desc_5: '只有账单状态为已对账才能进行操作',
  clear_desc_6: '只有确认状态为已确认才能进行操作',
  clear_desc_7: '不是同一账套的不支持一起申请核销！',
  changeTitle: '变更',
  ...
  updateTime: '更新人时间',
  updateContent: '更新内容',
  memberLocalName: '本地客户',
  channelOrderNo: '运单号',
  please_enter_order_no: '请输入订单号',
  please_enter_business_type: '请选择业务类型',
  add_charge_info: '新增费用',
  eta: 'ETA',
  customerBL: '客户提单',
  businessTag: '业务标签'
}

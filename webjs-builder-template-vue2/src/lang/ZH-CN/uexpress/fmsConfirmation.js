export default {
  ...
  removeBillInfo: '您确认将该确认单从账单：{billNo} 中移出吗？',
  batchConfirmInfo: '是否批量确认?',
  batchConfirmInfoSuccess: '批量确认成功',
  unallowBillInfo: '此操作后该确认单将不再入账，是否继续?',
  unallowBillSuccess: '不再入账成功',
  allowBillInfo: '此操作后该确认单将恢复入账，是否继续?',
  allowBillSuccess: '恢复入账成功',
  orderNo: '订单号',
  channelOrderNo: '运单号',
  memberOrderNo: '参考号',
  ...
  feeItemName: '费用项名称',
  chargeRuleDesc: '计费元素',
  chargeQuantity: '预估计费值',
  estimateChargeQuantity1: '预估计费值',
  estimateAmount: '应收费用',
  estimateOfferNo: '价卡编号',
  chargeQuantity1: '实际计费值',
  offerAmount: '实际应收',
  offerNo: '实际价卡',
  chargeAdjustDetail: '费用调整记录',
  adjustCharge: '调整费用',
  adjustReason: '调整原因',
  adjustAmount: '调整金额',
  adjustReceiveAmount: '调整后应收',
  adjustWeight: '调整重量(kg)',
  remark: '备注',
  adjustByName: '调整人',
  adjustTime: '调整时间',
  charge: '费用',
  batchAdjust: '批量调整',
  batchAdjustTemplate: '批量调整模板',
  addCharge: '添加费用项',
  export: '导出',
  batchConfirm: '批量确认',
  ...
  adjustSuccess: '调整成功',
  addSuccess: '添加成功',
  batchConfirmError: '已确认的费用确认单不能进行批量确认操作！',
  orderTime: '下单时间',
  productType: '业务类型',
  lastMileCollectDateTime: '尾程揽收时间',
  submitByName: '提交人',
  submitTime: '提交时间',
  batchOperInfo: '您确定要将{count}个费用确认单{oper}吗？',

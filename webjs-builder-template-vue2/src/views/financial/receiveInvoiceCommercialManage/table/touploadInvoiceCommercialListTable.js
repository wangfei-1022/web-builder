...
export default {
  defaultFlag: true,
  moduleName: '形票待回传(财务)',
  moduleCode: 'RECEIVE_COMMERCIAL_INVOICE_TOUPLOAD_FINANCE_PAGE',
  schemeName: '默认表头',
  schemeContent: [{
    field: 'index',
    headerNameKey: '',
    ...
    field: "uploadInvoiceFileCell",
    headerNameKey: 'fmsReceiveInvoice.upload_invoice_file_cell', // 扫描件发票
    width: 130,
    cellRendererFramework: "uploadInvoiceFileCell"
  }, {

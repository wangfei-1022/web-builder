...
<script>
import { getApplyClearListOffsetApi, getApplyClearListToclearOffsetApi, receiptApplyClearCancelApi } from "@/api/financial/fmsReceiptClear";
		...
		return {
          ...
          cellRendererFramework: "InstructionNo"
				},
				{
					...
					headerName: this.$t('fmsReceiveClear.businessTypeName'),
					minWidth: 100,
	...
	methods: {
		...
		async getList() {
			...
			if (this.role === "BUSINESS") {
				fn = getApplyClearListToclearOffsetApi;
			} else {
				fn = getApplyClearListOffsetApi;
			}

<template>
	<el-tabs type="border-card" class="top-tabs">
		...
		<el-tab-pane :label="$t('fmsReceiveClear.un_clear')">
			<clear-list-un role="BUSINESS" origin="ReceiptClearBusinessList"></clear-list-un>
		</el-tab-pane>
		<!--待对冲核销-->
		<el-tab-pane :label="$t('fmsReceiveClear.un_offset_clear')">
			<offset-clear-list-un role="BUSINESS" origin="ReceiptClearBusinessList"></offset-clear-list-un>
		</el-tab-pane>
		<!--全部核销-->
		<el-tab-pane :label="$t('fmsReceiveClear.all_clear')" lazy>
			<clear-list-all role="BUSINESS" origin="ReceiptClearBusinessList"></clear-list-all>
		</el-tab-pane>
		<!--全部对冲核销-->
		<el-tab-pane :label="$t('fmsReceiveClear.all_offset_clear')" lazy>
			<offset-clear-list-all role="BUSINESS" origin="ReceiptClearBusinessList"></offset-clear-list-all>
		</el-tab-pane>
	</el-tabs>
</template>

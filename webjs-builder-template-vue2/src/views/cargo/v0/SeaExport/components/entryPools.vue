  ...
  methods: {
    ...
    async nextStep() {
      if (this.checkEntryState) {
        this.$message({
          type: 'warning',
          message: this.$t('sea.expenseHasBeenAssociatedWithBill')
        })
        return false
      }
      if (this.checkSameMemberId) {
        this.$message({
          type: 'warning',
          message: this.$t('sea.pleaseSelectTheSameCustomer')
        })
        return false
      }
      if (this.checkSomeSettlementMode) {
        this.$message({
          type: 'warning',
          message: this.$t('sea.inconsistentExpenseSettlementMethods')
        })
        return false
      }
      ...
      //   this.$message({
      //     type: 'warning',
      //     message: this.$t('sea.theTicketSettlementFeeHasBeenConfirmed')
      //   })
      //   return false
      // }

<template>
  <div class="air-page" v-loading="loading" style="padding: 20px;">
          ...
          <el-form ref="multipleForm" :inline="true" :model="filter" label-width="80px">
            <el-form-item label="询盘流水号:">
              <el-input
               ...
               maxlength="50"
               :placeholder="$t('ETDInfoTable.placeholderInput')+$t('ETDInfoTable.vesselName')" size="mini"
               clearable
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick"  type="border-card">
      ...
      <el-tab-pane label="已审核(255)" name="3"></el-tab-pane>
    </el-tabs>
...
export default {
	...
	methods: {
		 ...
		 */
		edit(id) {
			this.$router.push({ name: `AirExportOperate`, query: { id } })
		},
		/**
		 * 充值查询条件
		 */

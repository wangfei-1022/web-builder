<template>
  <div class="air-page" v-loading="loading" style="padding: 20px;">
        ...
        <div class="multiple-form-wrap">
          <el-form ref="multipleForm" :inline="true" :model="filter" label-width="80px">
            <el-form-item label="订单号:">
              <el-input v-model.trim="filter.vesselName" maxlength="50" placeholder="请输入订单号" size="mini" clearable @keyup.enter.native="list"/>
            </el-form-item>
          </el-form>
        </div>
      </template>
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick"  type="border-card">
      <el-tab-pane label="待操作(255)" name="1"></el-tab-pane>
      <el-tab-pane label="待订舱(255)" name="2"></el-tab-pane>
      <el-tab-pane label="已订舱(255)" name="3"></el-tab-pane>
    </el-tabs>
...
export default {
	...
	methods: {
		 ...
		 */
		edit(id) {
			this.$router.push({ name: `AirExportOrderOperate`, query: { id } })
		},
		/**
		 * 充值查询条件
		 */

    ...
    <TopSearchItemsSlot :searchFun="list" :resetFun="reset" class="mb-10">
      <template slot="multipleSearch">
        <el-form ref="formData" :inline="true" :model="formData" class="search-form" label-width="100px">
          ...
          <el-form-item :label="getZH('blNo')" prop="mblNo">
...
export default {
  components: { SearchDatePicker },
    ...
    data() {
        return {
            origin: 'ThirdKindOrderListDomestic',
            groupCode: ThirdBusinessGroup.DOMESTIC_TRADE,
            columnDefsRight: [
                {
                ...
                {
                    headerName: this.getZH('vesselVoyage'),
                    field: 'vesselVoyage',
                    minWidth: 120,
                    cellRenderer: params => `${params.data.vessel || ""}/${params.data.voyage || ""}`
                },
                {
                ...
                {
                    headerName: this.getZH('podCodePort'),
                    field: 'podCode',
                    minWidth: 120
                },
                {
                    headerName: this.getZH('placeOfDelivery'),

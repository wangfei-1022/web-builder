...
<script>
import { createOfferCustomerLastApi, updateOfferCustomerLastApi, getDetailOfferCustomerLastApi } from "@/api/uexpress/priceCardCustomerLast";
		...
		onSubmit() {
          ...
          let data = {
            ...
            offerVersionId: this.offerVersionId
					...
					this.loading = true;
          let fn = this.offerVersionId ? updateOfferCustomerLastApi : createOfferCustomerLastApi
					fn(data).then(res => {
						if (res.ok) {

          ...
          <div class="info-section-module">
            ...
            <div class="info-content">
              ...
              <el-form-item :label='$t("uexpressPriceCard.productName")' prop="productCode">
                <uexpress-type-select type="productSales" v-model="form.productCode" clearable @selected="productCodeSelected" filterable />
              </el-form-item>
...
<script>
import { createOfferCustomerLastApi, updateOfferCustomerLastApi, getDetailOfferCustomerLastApi, copyInitOfferCustomerLastApi } from "@/api/uexpress/priceCardCustomerLast";
		...
		onSubmit() {
          ...
          let data = {
            ...
            sourceOfferVersionId: this.offerVersionId
					...
					this.loading = true;
					copyInitOfferCustomerLastApi(data).then(res => {
						if (res.ok) {

<template>
  <el-form ref="baseForm" :rules="formRule" :model="form" label-width="70px" size="mini" class="member-form">
    <div class="base-item">
      <i class="iconfont icon-minus-circle minus-btn" @click="deleteFn" v-if="!isDisabled"></i>
      ...
      <el-form-item :label="$t('uexpressProduct.effective_time')" prop="effectiveTime">
        <CommonPicker v-model="form.effectiveTime" pikcer-type="datetime" pickerFormat="yyyy-MM-dd HH:mm:ss" :disabled="isDisabled"/>
      </el-form-item>
    </div>
    ...
    <div v-if="[1, 2, 3, 5].indexOf(form.restrictionCategory) >= 0">
      <div class="base-item">
        <el-form-item label="" prop="test" label-width="0px" style="text-align: right;">
          <i data-v-2caf994f="" class="iconfont icon-add-circle" @click="addSecond" v-if="!isSecond && !isDisabled"></i>
        </el-form-item>
      ...
      <div class="base-item second" v-if="isSecond">
        <el-form-item label="" prop="test" label-width="0px" style="text-align: right;">
          <i data-v-2caf994f="" class="iconfont icon-minus-circle" @click="removeSecond" v-if="!isDisabled"></i>
        </el-form-item>
...
export default {
  ...
  computed: {
    isDisabled() {
      return this.type !== 'ADD' && !this.isEdit
    }
  },
	data() {
		return {

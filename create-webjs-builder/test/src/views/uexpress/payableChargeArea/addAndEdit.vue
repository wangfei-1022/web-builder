		...
		<div class="customer-edit page-edit-content">
            ...
            <i class="icon-oper el-icon-circle-check" @click="saveBaseFn" v-if="type == 'EDIT' && isEditBase"></i>
              ...
              ></type-select>
						...
						<el-form-item :label='$t("uexpressProduct.supplier_product")' prop="productId" v-if="false">
...
export default {
	name: "UexpressChargeAreaPayableAddAndEdit",
	components: {
    AreaDetail
	},
  props: {
    ...
    saveBaseFn() {
      this.$refs.baseForm.validate(valid => {
		...
		backList() {
			...
			this.$router.push({ name: `UexpressChargeAreaPayable` });
		}
	}
};
</script>

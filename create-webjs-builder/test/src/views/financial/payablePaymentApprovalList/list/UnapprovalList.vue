...
import {
  getPayablePaymentUnapprovalApi,
  getPayablePaymentUnapprovalTotalApi,
  getPayablePaymentApprovalApi,
  getPayablePaymentApprovalTotalApi
} from "@/api/financial/fmsPayablePayment";
import mixins from '@/views/financial/payablePaymentApprovalList/list/mixins'
import NextApprovalUser from "@/views/financial/payablePaymentApplyList/components/NextApprovalUser";
import BatchOperDialog from "../components/BatchOperDialog";

export default {
	name: "PayablePaymentApprovalList",
  components: {
    NextApprovalUser,
	BatchOperDialog
  },
  ...
  props: {
	...
	methods: {
      ...
      let params = this.getParams()
			this.loading = true;
			getPayablePaymentUnapprovalApi(params).then(res => {
        if (res.ok) {
      ...
      getPayablePaymentUnapprovalTotalApi(params).then(res => {
        if (res.ok) {

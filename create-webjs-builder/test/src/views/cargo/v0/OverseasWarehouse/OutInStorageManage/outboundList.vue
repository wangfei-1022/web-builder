 <template>
  <div class="pd-16" v-loading="loading"  style="padding-top: 0">
      ...
      <template slot="multipleSearch">
        <el-form :inline="true" :model="formData" label-width="130px" ref="formData">
          ...
          <el-form-item :label="getZH('outTime')">
            ...
            <el-date-picker size="mini" v-model="dateTime" type="datetimerange" :start-placeholder="getZH('startDate','common')" :end-placeholder="getZH('endDate','common')" value-format="timestamp"
                            :default-time="['00:00:00','23:59:59']" @change="list">
            </el-date-picker>
          </el-form-item>
          ...
          <el-form-item :label="getZH('skuNumber')" prop="skuCode">
            <el-input size="mini" v-model.trim="formData.skuCode" :placeholder="inputZH('skuNumber')" @keyup.enter.native="list" maxlength="50"></el-input>
          </el-form-item>
          ...
          <el-form-item :label="getZH('submitTime')">
            ...
            <el-date-picker size="mini" v-model="submitTime" type="datetimerange" :start-placeholder="getZH('startDate','common')" :end-placeholder="getZH('endDate','common')" value-format="timestamp"
                            :default-time="['00:00:00','23:59:59']" @change="list">
            </el-date-picker>
          </el-form-item>
        </el-form>
    ...
    <BatchImportShipmentNoDialog :visible.sync="batchImportShipmentVisible" />
...
export default {
    ...
    created() {
        this.columnFields = outboundListTable;
        this.gridOptions = {
            context: {
    ...
    methods: {
        ...
        async list() {
            ...
            if (this.activeName === 'NO_SEARCH') {
                fn = getOutboundsListBatchApi
            } else {
                fn = getOutboundsListApi
            }

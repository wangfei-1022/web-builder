...
function createApp() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // 下载模板
            logger.await('正在下载');
            yield execx(`git clone --depth=1 git@github.com:wangfei-1022/web-builder.git`, { cwd: tempPath });
            const templateRoot = (0, path_1.join)(tempPath, 'web-builder/generator/' + templateName);

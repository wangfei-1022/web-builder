      ...
      <template slot="multipleSearch">
        <div class="multiple-no-wrap">
          <el-form ref="formDataRef" :inline="true" :model="nosFormData" label-width="110px" size="mini" class="multipleNoSearch">
            ...
            <el-form-item :label="getZH('customerName', 'common')" prop="customerIds">
            ...
            <el-form-item :label="getZH('status')" prop="statusList">
                <el-select size="mini" v-model="nosFormData.statusList" multiple>
    ...
    <top-search-items-slot :filterType="'mutliple'" :searchFun="list" :resetFun="reset" class="mb-10" :visible="activeName === 'BASE_SEARCH'">
      <template slot="multipleSearch">
        <el-form :inline="true" :model="formData" label-width="130px" ref="formData">
          ...
          <el-form-item :label="getZH('loadingReference')" prop="loadingReference">
            <el-input size="mini" v-model.trim="formData.loadingReference" :placeholder="inputZH('loadingReference')" @keyup.enter.native="list" maxlength="50"></el-input>
          </el-form-item>
          <el-form-item :label="getZH('commercialInvoice')" prop="commercialInvoice">
            <el-input size="mini" v-model.trim="formData.commercialInvoice" :placeholder="inputZH('commercialInvoice')" @keyup.enter.native="list" maxlength="50"></el-input>
          </el-form-item>
        </el-form>
      </template>
    </top-search-items-slot>
...
import {
    getTransferOutboundsListApi,
    getTransferOutboundsListBatchApi,
    getProductListApi,
...
import transferBoundListTable from './table/transferBoundListTable';
...
export default {
    ...
    created() {
        ...
        this.columnFields = transferBoundListTable;
        this.init();
        this.list();
    },
    ...
    methods: {
        ...
        async list() {
            ...
            let fn = null
            if (this.activeName === 'NO_SEARCH') {
                fn = getTransferOutboundsListBatchApi
            } else {
                fn = getTransferOutboundsListApi
            }

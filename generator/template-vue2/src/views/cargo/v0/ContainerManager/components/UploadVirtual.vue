<template>
  <div>
    <el-dialog ref="formData" :visible.sync="dialogVisible" :title="$t('containerManager.importVirtualNo')" width="550px" :close-on-click-modal="false">
...
<script>
import { uploadVirtualNoApi } from '@/api/containerManager'
...
export default {
  ...
  methods: {
    ...
    async saveForm() {
      ...
      const res = await uploadVirtualNoApi(saveData)
      if (res.ok) {

		...
		<div class="customer-edit page-edit-content">
          ...
          <div class="info-content">
            <div class="info-item full-line">
              <span class="info-label">{{$t("uexpressPriceCard.supplierName")}}：</span>
...
<script>
import { createOfferSupplierApi, updateOfferSupplierApi, getDetailOfferSupplierApi, updatePriceOfferSupplierApi } from "@/api/uexpress/priceCardSupplier";
...
export default {
	name: "UexpressPriceCardSupplierPayableEditPrice",
	components: {
    PriceEdit
  },
  props: {
    ...
    getDetail() {
      ...
      this.loading = true;
      updatePriceOfferSupplierApi(data).then(res => {
        if (res.ok) {

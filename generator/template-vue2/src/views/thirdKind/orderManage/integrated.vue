      ...
      <template slot="multipleSearch">
        <el-form ref="formData" :inline="true" :model="formData" class="search-form" label-width="100px">
          ...
          <el-form-item :label="getZH('polCode')" prop="polCode">
            <el-input v-model="formData.polCode" size="mini" :placeholder="inputZH('polCode')" clearable @keyup.enter.native="list" />
          </el-form-item>
          <el-form-item :label="getZH('podCode')" prop="podCode">
            <el-input v-model="formData.podCode" size="mini" :placeholder="inputZH('podCode')" clearable @keyup.enter.native="list" />
          </el-form-item>
...
export default {
  components: { SearchDatePicker },
    ...
    data() {
        return {
            origin: 'ThirdKindOrderListIntegrated',
            groupCode: ThirdBusinessGroup.INTEGRATED_SERVICE,
            columnDefsRight: [
                {
